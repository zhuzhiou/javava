...
public class WxPayRequest {
    ...
    public String requestWithoutCert(String url, String data) throws Exception {
        return this.request(url, data, apiConfig.getHttpConnectTimeout(),apiConfig.getHttpReadTimeout());
    }
     ...
     * @return
     */
    public String requestWithCert(String url, String data,InputStream certStream) throws Exception {
        return this.request(url, data, apiConfig.getHttpConnectTimeout(),apiConfig.getHttpReadTimeout(),certStream);
    }
